...
#元画像フォルダ
in_path = 'C://Users//AIH_Guest//Desktop//Eye_position//program//Control_photo'
#保存先フォルダ
out_path = 'C://Users//AIH_Guest//Desktop//Eye_position//program//Control_photo_eyes'

def eyes_cutout():
    path = glob.glob(in_path + '//*.jpg')
    im_black = Image.open('C://Users//AIH_Guest//Desktop//Eye_position//program//black.jpg')
    k = 0
    x = 0
